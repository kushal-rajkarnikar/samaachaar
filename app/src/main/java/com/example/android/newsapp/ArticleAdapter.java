    ...
    public class  ArticleAdapter extends ArrayAdapter<Article>{
        ...
        Context mContext;
        String mhomeScreenorNot = "world";

        public ArticleAdapter(Context context, ArrayList<Article> appArticles, String homeScreenOrNot) {
            super(context,0, appArticles);
            mContext = context;
            mhomeScreenorNot = homeScreenOrNot;
        }
